            ...
            try:
                ...
                while(getFlag() == 0):
                    try:
                        ...
                        self.data[8] = self.helper(self.data[8])
                        self.data[0] = self.helper(self.data[0])
                        self.data[1] = self.helper(self.data[1])
                        self.data[2] = self.helper(self.data[2])
                        self.data[3] = self.helper(self.data[3])
                        self.data[4] = self.helper(self.data[4])
                        self.data[5] = self.helper(self.data[5])
                        self.data[6] = self.helper(self.data[6])
                        self.data[7] = self.helper(self.data[7])
                        self.data[9] = self.helper(self.data[9])
                        self.data[10] = self.helper(self.data[10])
                        self.data[11] = self.helper(self.data[11])
                        self.data[12] = self.helper(self.data[12])
                        self.data[13] = self.helper(self.data[13])
                        self.data[14] = self.helper(self.data[14])
                        self.data[15] = self.helper(self.data[15])
                        changeAll(app)
...
class Pressure:
    def __init__(self, obj):
        ...
        self.p_txt = self.txtCanvas.create_text(5, 15, fill="black", text="Pressr:         Bar", font=('Helvetica 14 bold'), anchor=W)
        self.value_txt = self.txtCanvas.create_text(75, 15, fill="black", text="0", font=('Helvetica 14 roman'), anchor=W)
...
class Power:
    def __init__(self, obj):
        ...
        self.pCanvas = Canvas(obj.window, height=25, width=140,
...
class Temperature:
    def __init__(self, obj):
        self.temperatureCanvas = Canvas(
            obj.window, height=120, width=120, background="white", highlightthickness=1)
        ...
        self.p1Canvas = Canvas(
            obj.window, height=25, width=120, background="white", highlightthickness=1)
...
class Speed:
    def __init__(self, obj):
        ...
        self.xCanvas = Canvas(obj.window, height=25, width=160,
                              background="white", highlightthickness=1)
        self.xCanvas.place(x=0, y=140)
        self._X_ = self.xCanvas.create_text(5, 5, fill="black", text="X-Sp:             m/s", font=('Helvetica 14 bold'), anchor=NW)
        self._X_Speed = self.xCanvas.create_text(70, 5, fill="black", text="0", font=('Helvetica 14 roman'), anchor=NW)

        self.yCanvas = Canvas(obj.window, height=25, width=160,
                              background="white", highlightthickness=1)
        self.yCanvas.place(x=0, y=165)
        self._Y_ = self.yCanvas.create_text(5, 5, fill="black", text="Y-Sp:             m/s", font=('Helvetica 14 bold'), anchor=NW)
        self._Y_Speed = self.yCanvas.create_text(70, 5, fill="black", text="0", font=('Helvetica 14 roman'), anchor=NW)

        self.zCanvas = Canvas(obj.window, height=25, width=160,
                              background="white", highlightthickness=1)
        self.zCanvas.place(x=0, y=190)
        self._Z_ = self.zCanvas.create_text(5, 5, fill="black", text="Z-Sp:             m/s", font=('Helvetica 14 bold'), anchor=NW)
        self._Z_Speed = self.zCanvas.create_text(70, 5, fill="black", text="0", font=('Helvetica 14 roman'), anchor=NW)


class Acceleration:
    def __init__(self, obj):
        self.accelerationCanvas = Canvas(
            obj.window, height=140, width=160, background="white", highlightthickness=1)
        ...
        self._X_ = self.xCanvas.create_text(
            5, 5, fill="black", text="X-Acc:          m/s2", font=('Helvetica 14 bold'), anchor=NW)
        self._X_Acc = self.xCanvas.create_text(
            70, 15, fill="black", text="0", font=('Helvetica 14 roman'), anchor=W)

        self.yCanvas = Canvas(obj.window, height=25, width=160,
                              background="white", highlightthickness=1)
        self.yCanvas.place(x=0, y=450, anchor=SW)
        self._Y_ = self.yCanvas.create_text(
            5, 5, fill="black", text="Y-Acc:          m/s2", font=('Helvetica 14 bold'), anchor=NW)
        ...
        self._Z_ = self.zCanvas.create_text(
            5, 5, fill="black", text="Z-Acc:          m/s2", font=('Helvetica 14 bold'), anchor=NW)
...
class Location:
    def __init__(self, obj):
        self.locationCanvas = Canvas(
            obj.window, height=150, width=160, background="white", highlightthickness=1)
        ...
        self._X_ = self.xCanvas.create_text(
            5, 15, fill="black", text="X-Loc:              m", font=('Helvetica 14 bold'), anchor=W)
        ...
        self._Y_ = self.yCanvas.create_text(
            5, 15, fill="black", text="Y-Loc:              cm", font=('Helvetica 14 bold'), anchor=W)
        ...
        self._Z_ = self.zCanvas.create_text(
            5, 15, fill="black", text="Z-Loc:              cm", font=('Helvetica 14 bold'), anchor=W)
...
class Maneuver:
    def __init__(self, obj):
        ...
        #roll, pitch ve yaw
        self.yawCanvas = Canvas(
            obj.window, height=25, width=160, background="white", highlightthickness=1)
        self.yawCanvas.place(relx=1, y=425, anchor=SE)
        self._Yaw_ = self.yawCanvas.create_text(
            17, 15, fill="black", text=" Yaw:             \N{DEGREE SIGN}", font=('Helvetica 14 bold'), anchor=W)
        self._Yaw_Deg = self.yawCanvas.create_text(
            80, 15, fill="black", text="0", font=('Helvetica 14 roman'), anchor=W)

        self.rollCanvas = Canvas(
            obj.window, height=25, width=160, background="white", highlightthickness=1)
        self.rollCanvas.place(relx=1, y=450, anchor=SE)
        self._Roll_ = self.rollCanvas.create_text(
            15, 15, fill="black", text="  Roll:             \N{DEGREE SIGN}", font=('Helvetica 14 bold'), anchor=W)
        self._Roll_Deg = self.rollCanvas.create_text(
            80, 15, fill="black", text="0", font=('Helvetica 14 roman'), anchor=W)

        self.pitchCanvas = Canvas(
            obj.window, height=25, width=160, background="white", highlightthickness=1)
        self.pitchCanvas.place(relx=1, rely=1, anchor=SE)
        self._Pitch_ = self.pitchCanvas.create_text(
            15, 15, fill="black", text="Pitch:             \N{DEGREE SIGN}", font=('Helvetica 14 bold'), anchor=W)
...
def updatePressure(obj, value):
    ...
    obj.value_txt = obj.txtCanvas.create_text(
        75, 15, fill="black", text=value[8], font=('Helvetica 14 roman'), anchor=W)
...
def updatePower(obj, value):
    ...
    obj.value_txt = obj.pCanvas.create_text(
        70, 16, fill="black", text=value+" W", font=('Helvetica 14 roman'), anchor=CENTER)
...
def updateLocation(obj, value):
    ...
    obj._X_Loc = obj.xCanvas.create_text(
        70, 15, fill="black", text=value[9], font=('Helvetica 14 roman'), anchor=W)

    obj.yCanvas.delete(obj._Y_Loc)
    obj._Y_Loc = obj.yCanvas.create_text(
        70, 15, fill="black", text=value[10], font=('Helvetica 14 roman'), anchor=W)

    obj.zCanvas.delete(obj._Z_Loc)
    obj._Z_Loc = obj.zCanvas.create_text(
        70, 15, fill="black", text=value[11], font=('Helvetica 14 roman'), anchor=W)
...
def updateAcceleration(obj, value):
    ...
    obj._X_Acc = obj.xCanvas.create_text(
        70, 15, fill="black", text=value[3], font=('Helvetica 14 roman'), anchor=W)

    obj.yCanvas.delete(obj._Y_Acc)
    obj._Y_Acc = obj.yCanvas.create_text(
        70, 15, fill="black", text=value[4], font=('Helvetica 14 roman'), anchor=W)

    obj.zCanvas.delete(obj._Z_Acc)
    obj._Z_Acc = obj.zCanvas.create_text(
        70, 15, fill="black", text=value[5], font=('Helvetica 14 roman'), anchor=W)
...
def updateSpeed(obj, value):
    ...
    obj._X_Speed = obj.xCanvas.create_text(70, 5, fill="black", text=value[0], font=('Helvetica 14 roman'), anchor=NW)

    obj.yCanvas.delete(obj._Y_Speed)
    obj._Y_Speed = obj.yCanvas.create_text(70, 5, fill="black", text=value[1], font=('Helvetica 14 roman'), anchor=NW)

    obj.zCanvas.delete(obj._Z_Speed)
    obj._Z_Speed = obj.zCanvas.create_text(70, 5, fill="black", text=value[2], font=('Helvetica 14 roman'), anchor=NW)
def changeSpeed(obj):
